...
def read_ebay_examples(input_file, is_training, version_2_with_negative):
    """Read ebay excel file into a list of SquadExample."""
    ...
    for index, row in df.iterrows():
        ...
        start_position, end_position = row["Span"].split(' ')
        start_position, end_position = int(start_position), int(end_position)

        # print("question_text", question_text)
        # print("start_position", type(start_position))
        # print("end_position", end_position)
        # print("orig_answer_text", orig_answer_text)
